...
namespace LiteCommerce.BusinessLayers
{
    public static class CatalogBLL
    {
        ...
        public static List<Customer> Customer_List_Helper()
        {
            return CustomerDB.List_Helper();
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public static List<Product> Product_List_Helper()
        {
            return ProductDB.List_Helper();
        }
        /// <summary>
        /// 
        /// </summary>
